...
def main():
    # Step 1: Create a random weighted graph
    print_step(1, "Creating a random weighted graph")
    ...
    visualize_graph(G, "Random Graph", "random_graph.png")
    ...
    visualize_partitions(G, result['partitions'], "Random Graph Partitions", "random_partitions.png")
    ...
    # Visualize cut edges
    visualize_cut_edges(G, result['partitions'], "Random Graph Cut Edges", "random_cut_edges.png")
    ...
    for i, cut in enumerate(result['all_min_cuts']):
        ...
        visualize_partitions(G, cut, f"Random Graph Alternative Cut {i+1}", f"random_alternative_cut_{i+1}.png")
